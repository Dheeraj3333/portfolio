...
const NavbarMain = () => {
  ...
  return (
    <nav className="flex gap-4 items-center mx-auto sticky top-0 z-50">
      <div className=" w-full border-2 border-white bg-black items-center mx-auto rounded-full flex justify-between px-4 py-4 my-4">
        <NavbarLogo />
